...
public class Taxi extends EntityCar {
	...
	public Taxi(int x, int y, double velocidade) {// o carro será gerado sempre com pré definiçoes, com IPVA, abastecido e calibrado pronto para rodar
		super(x, y, velocidade, "assets/cars/taxi.png");
